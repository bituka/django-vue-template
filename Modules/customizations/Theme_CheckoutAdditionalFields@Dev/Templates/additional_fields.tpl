...
<div class="additional-info-column">
  ...
  <div class="address-edit-fields-group" style="border:none;">
    <h4 class="order-wizard-showshipments-module-shipping-title additional-fields-tittle"> PO Number </h4>
		<div class="address-edit-fields-group-form-controls">
			<input type="tel" class="address-edit-fields-group-input" id="ponumber">
		</div>
	</div>
