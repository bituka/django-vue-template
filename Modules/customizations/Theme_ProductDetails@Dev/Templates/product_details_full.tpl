                    ...
                    {{#if isItemProperlyConfigured}}
                        <form id="product-details-full-form" data-action="submit-form" method="POST">
                            ...
                            <div class="product-details-share-section">
                                ...
                                <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#ra-5a2d91c88c17dd01"></script>
        ...
        <div class='custom-pdp-tabs' id='myTabs'>
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active">
                    <button data-target="#tab-1" aria-controls="tab-1" role="tab" data-toggle="tab">Description</button>
                </li>
                <li role="presentation">
                    <button data-target="#tab-2" aria-controls="profile" role="tab" data-toggle="tab">Additional info</button>
                </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="tab-2">{{{addInformation}}}
                    {{#if warranty}}
                        <hr> {{/if}} {{{warranty}}}</div>
            </div>
